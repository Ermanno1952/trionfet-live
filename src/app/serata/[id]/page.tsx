...
export default function Serata() {
  ...
  <div className="min-h-screen bg-gradient-to-br from-green-900 to-black text-white p-6 flex flex-col items-center">
    <div className="w-full max-w-lg">
      ...
      {/* PULSANTE FINISCI SERATA (compare dopo almeno 1 batifondo vinto) */}
      ...
      {/* SCHERMATA FINALE */}
      {serataFinita && (
        <div className="mt-12 p-10 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-3xl text-center animate-bounce">
          ...
          <p className="text-2xl mt-6">Alla prossima batosta!</p>
        </div>
      )}
